...
public class M3TableFrame extends JFrame{
	     public M3TableFrame(List<User> list) {
	  		...
	  		for (User user : list) {
	  			...
	  			objs.add(new Double(user.getDeposit()));
	  			
	  			vectordate.add(objs);
	  		}
	  		String[] labels = { "卡号", "持卡人姓名", "书本数", "书本状态","押金" };
	  		...
	  		scrollPane.setBorder(new TitledBorder(null, "分面板", TitledBorder.LEADING, TitledBorder.TOP, null, null));
